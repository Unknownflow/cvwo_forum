...
func (s *postService) GetAllCommentsByPostID(id int, key string, order string) ([]models.CommentResponse, error) {
	comments, err := s.postRepo.ReadCommentsByPostID(id, key, order)
