...
type TopicService interface {
	...
	GetAllPostsByTopicID(id int, order string) ([]models.PostResponse, error)
...
func (s *topicService) GetAllPostsByTopicID(id int, order string) ([]models.PostResponse, error) {
	posts, err := s.topicRepo.ReadPostsByTopicID(id, order)
